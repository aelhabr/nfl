...
save_as_xlsx <- function(data = NULL,
  ...
  # timestamp = timestamp_runtime_ymd # NULL
  # colname_timestamp = "timestamp_download_ymd"
  # colname_arrange = colname_timestamp
  # ws_name = "lines" # NULL
  # filename_save = "betting_stats"
...
# save_as_xlsx(lines_truncated, timestamp_runtime_ymd, "timestamp_download_ymd", ws_name = "lines")
